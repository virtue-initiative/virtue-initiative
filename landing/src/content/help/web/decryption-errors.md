...
permanently fails to decrypt. This page explains why, and what you need to
...
Resetting your password always generates a new private key. There is no way
...
the web app doesn't understand (or vice versa). Update your on-device app to the
latest version to prevent this for future batches; already-uploaded batches in
...
reset or a known version mismatch, report a problem using the mechanism in the
app or website with the error message shown in the dialog so we can investigate.
