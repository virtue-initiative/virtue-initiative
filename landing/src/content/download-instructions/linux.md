...
5. Enter that code on the [Devices page](/app/devices) of the web app, under **Add device**. See [Adding a device](/help/web/adding-a-device) for the full walkthrough.
...
To sign in with your email and password instead of a code, run `virtue login --password`.
