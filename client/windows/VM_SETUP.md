...
- `C:\virtue-build\src\client\windows\dist\virtue-windows-0.1.3-dev.msix`
- `C:\virtue-build\src\client\windows\dist\virtue-windows-0.1.3-dev-setup.zip`
...
.\windows\scripts\build-msix.ps1 -Profile Debug -Version 0.1.3-dev
```
