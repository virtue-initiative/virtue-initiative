---
name: spec-implement
description: Use when the user asks to implement a spec.
---

All spec files follow RFC language.

1. Read the spec file diff
2. Review relevant parts of the codebase
3. Plan out an implementation BASED ON the diff of the spec
